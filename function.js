...
var result1 = buildName('catherine'); // error,too few parameters
var result2 = buildName('catherine', 'Z.', 'Sr.'); //error, too many parameters
...
var result4 = buildName2('catherine'); //works correctly now
var result5 = buildName2('catherine', 'Z.', 'Sr.'); // error, too many parameters
...
function buildNameMany(firstName) {
    var restOfName = [];
